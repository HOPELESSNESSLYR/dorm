<template>
  <div>
  <object id="objActiveX" classid="clsid:A66F5373-0A8A-4C42-814B-38A87B331D40" width=0 height=0">
  ...
  <table width="750px" border="0" cellspacing="1" cellpadding="2" align="center" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td colspan="2">
        <textarea rows="10" name="text_result" id="text_result" style="color:#FF0000" cols="70" readonly></textarea>
      </td>
    </tr>
  </table>
  </div>
