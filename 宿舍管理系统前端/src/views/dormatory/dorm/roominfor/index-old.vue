  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="区域名称" prop="areaName">
        <el-select v-model="queryParams.areaName" placeholder="请选择区域名称" clearable>
          <el-option
            v-for="dict in dict.type.dorm_area"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
      ...
      <el-form-item label="宿舍楼位置" prop="floorLocation">
        <el-input
          v-model="queryParams.floorLocation"
          placeholder="请输入宿舍楼位置"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="房间号前缀" prop="roomPrefix">
        <el-input
          v-model="queryParams.roomPrefix"
          placeholder="请输入房间号前缀"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="性别" prop="roomSex">
        <el-select v-model="queryParams.roomSex" placeholder="请选择性别" clearable>
          <el-option
            v-for="dict in dict.type.dorm_sex"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
      ...
      <el-form-item label="宿舍可住人数" prop="livenumber">
        <el-select v-model="queryParams.livenumber" placeholder="请选择宿舍可住人数" clearable>
          <el-option
            v-for="dict in dict.type.dorm_people_count"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
      ...
      <el-form-item label="宿舍人员信息卡" prop="roomCard">
        <el-input
          v-model="queryParams.roomCard"
          placeholder="请输入宿舍人员信息卡"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="楼栋号" prop="cavenumber">
        <el-input
          v-model="queryParams.cavenumber"
          placeholder="请输入楼栋号"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="住宿费用承担人" prop="costman">
        <el-input
          v-model="queryParams.costman"
          placeholder="请输入住宿费用承担人"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['dorm:roominfor:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['dorm:roominfor:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleImport"
          v-hasPermi="['dorm:roominfor:import']"
        >导入</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['dorm:roominfor:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="roominforList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="ID" align="center" prop="id" />
      <!--<el-table-column label="区域编号" align="center" prop="areaNumber" />-->
      <el-table-column label="区域名称" align="center" prop="areaName">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.dorm_area" :value="scope.row.areaName"/>
        </template>
      </el-table-column>
      <!--<el-table-column label="宿舍楼编号" align="center" prop="floorNumber" />-->
      <el-table-column label="宿舍楼名称" align="center" prop="floorName" />
      <el-table-column label="宿舍楼位置" align="center" prop="floorLocation" />
      <el-table-column label="宿舍楼层号" align="center" prop="dormFloor" />
      <el-table-column label="宿舍房间号" align="center" prop="roomNumber" >
        <template slot-scope="scope">
          <router-link :to="'/dormatory/dorm/DormBed/dictDormBed/index/' + scope.row.areaNumber+','+scope.row.floorNumber+','+scope.row.dormFloor+','+scope.row.roomNumber" class="link-type">
            <span>{{ scope.row.roomNumber }}</span>
          </router-link>
        </template>
      </el-table-column>
      <!--<el-table-column label="房间号前缀" align="center" prop="roomPrefix" />-->
      <el-table-column label="性别" align="center" prop="roomSex">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.dorm_sex" :value="scope.row.roomSex"/>
        </template>
      </el-table-column>
      <el-table-column label="宿舍可住人数" align="center" prop="livenumber">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.dorm_people_count" :value="scope.row.livenumber"/>
        </template>
      </el-table-column>
      <el-table-column label="宿舍实际人数" align="center" prop="peoplenumber">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.dorm_people_count" :value="scope.row.peoplenumber" :style="{color:scope.row.peoplenumber==scope.row.livenumber ? '#FF0000' : '#606266'}"/>
        </template>
      </el-table-column>
      <el-table-column label="宿舍剩余可住" align="center" prop="remainnumber">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.dorm_people_count" :value="scope.row.remainnumber"/>
        </template>
      </el-table-column>
      <el-table-column label="宿舍类型" align="center" prop="roomType" />
      <el-table-column label="房间状态" align="center" prop="roomStatus" />
      <el-table-column label="柜子数量" align="center" prop="cabinetNumber" />
      <!--<el-table-column label="宿舍固定资产信息" align="center" prop="roomProperty" />
      <el-table-column label="宿舍人员信息" align="center" prop="roomPeople" />
      <el-table-column label="宿舍人员信息卡" align="center" prop="roomCard" />
      <el-table-column label="是否临时" align="center" prop="temporary" />
      <el-table-column label="楼栋号" align="center" prop="cavenumber" />
      <el-table-column label="住宿费用" align="center" prop="cost" />
      <el-table-column label="住宿费用承担人" align="center" prop="costman" />-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body v-dialogDrag>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="性别" prop="roomSex">
          <el-select v-model="form.roomSex" placeholder="请选择性别">
            <el-option
              v-for="dict in dict.type.dorm_sex"
              :key="dict.value"
              :label="dict.label"
              ...
              <el-row :gutter="14">
                <el-col :span="24">
                  <el-form-item label="姓名" prop="name">
                    <el-select v-model="formData.name" placeholder="请选择姓名" filterable clearable
                               :style="{width: '100%'}" @click="getonlivepeople" @change="getonlivepeopleinfo($event)">
                      <el-option v-for="(item, index) in nameOptions" :key="index" :label="item.label"
              ...
              <el-row :gutter="15">
                <el-col :span="24">
                  <el-form-item label="床位号" prop="bed">
                    <el-select v-model="formData.bed" placeholder="请选择床位" filterable clearable
                               :style="{width: '100%'}">
                      <el-option v-for="(item, index) in bedOptions" :key="index" :label="item.label"
                                 :value="item.value" :disabled="item.disabled"></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
          ...
          <el-form ref="elForm2" :model="formData2" :rules="rules2" size="medium" label-width="100px">
                ...
                <el-col :span="24">
                  <el-form-item label="调换人姓名" prop="name1">
                    <el-select v-model="formData2.name1" placeholder="请输入调换人姓名" clearable filterable
                      ...
                      <el-option v-for="(item, index) in name1Options2" :key="index" :label="item.label"
                                 :value="item.value" :disabled="item.disabled"></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
              ...
              <el-row :gutter="15">
                <el-col :span="24">
                  <el-form-item label="区域编号" prop="areaNumber1">
                    <el-select v-model="formData2.areaNumber1" placeholder="请输入区域编号" clearable
                               :style="{width: '100%'}">
                      <el-option v-for="dict in dict.type.dorm_areaNumber"
                                 :key="dict.value"
                                 :label="dict.label"
              ...
              <el-row :gutter="15">
                <el-col :span="24">
                  <el-form-item label="宿舍楼" prop="floorName1">
                    <el-select v-model="formData2.floorName1" placeholder="请输入宿舍楼" clearable
                               :style="{width: '100%'}">
              ...
              <el-row :gutter="15">
                <el-col :span="24">
                  <el-form-item label="楼层" prop="dormFloor1">
                    <el-select v-model="formData2.dormFloor1" placeholder="请选择楼层" clearable
                               :style="{width: '100%'}">
              ...
              <el-row :gutter="15">
                <el-col :span="24">
                  <el-form-item label="房间号" prop="room1">
                    <el-select v-model="formData2.room1" placeholder="请选择房间号" filterable clearable :style="{width: '100%'}">
                      <el-option v-for="(item, index) in room1Options2" :key="index" :label="item.label"
                                 :value="item.value" :disabled="item.disabled"></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
              ...
              <el-row :gutter="15">
                <el-col :span="24">
                  <el-form-item label="床位号" prop="bed1">
                    <el-select v-model="formData2.bed1" placeholder="请选择床位号" clearable :style="{width: '100%'}" @focus="getkongbedinfo3">
                      <el-option v-for="(item, index) in bed1Options2" :key="index" :label="item.label"
                                 :value="item.value" :disabled="item.disabled"></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
            ...
            <el-col :span="24">
              <el-form-item label="原因" prop="reason">
                <el-input v-model="formData2.reason" placeholder="请输入原因" clearable
                           :style="{width: '100%'}"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="备注" prop="remarks">
                <el-input v-model="formData2.remarks" placeholder="请输入备注" clearable
                          :style="{width: '100%'}"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="24">
        ...
        <el-form ref="elForm3" :model="formData3" :rules="rules3" size="medium" label-width="100px">
          ...
          <el-col :span="12">
            <el-row :gutter="15">
              <el-col :span="24">
                <el-form-item label="姓名" prop="name">
                  <el-select v-model="formData3.name" placeholder="请输入姓名" clearable filterable
                             :style="{width: '100%'}" @change="getlivepeopleinfo3($event)">
                    <el-option v-for="(item, index) in nameOptions2" :key="index" :label="item.label"
                               :value="item.value" :disabled="item.disabled"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              ...
              <el-col :span="24">
                <el-form-item label="性别" prop="sex">
                  <el-select v-model="formData3.sex" placeholder="请选择性别" clearable :style="{width: '100%'}">
                    <el-option v-for="dict in dict.type.dorm_sex"
                               :key="dict.value"
                               :label="dict.label"
                               :value="dict.value"></el-option>
                  </el-select>
            ...
            <el-row :gutter="15">
              <el-col :span="24">
                <el-form-item label="床位号" prop="bedNumber">
                  <el-select v-model="formData3.bedNumber" placeholder="请选择床位号" clearable
                             :style="{width: '100%'}">
                    <el-option v-for="dict in dict.type.bed_Number"
                               :key="dict.value"
                               :label="dict.label"
                               :value="dict.value"></el-option>
                  </el-select>
              ...
              <el-col :span="24">
                <el-form-item label="未归还物品详情" prop="articleDescription">
                  <el-checkbox-group v-model="formData3.articleDescription">
                    <el-checkbox v-for="(item, index) in formData3.articleDescriptionOptions" :key="index" :label="item.label"
                                 :disabled="item.disabled" :value="item.value"></el-checkbox>
                  </el-checkbox-group>
          ...
          <el-form ref="elForm4" :model="formData4" :rules="rules4" size="medium" label-width="100px">
            <el-col :span="12">
              <el-row :gutter="15">
                <el-col :span="24">
                  <el-form-item label="区域编号" prop="areaNumber">
                    <el-input v-model="formData4.areaName" placeholder="请输入区域编号" clearable
                               :style="{width: '100%'}">
                    </el-input>
                  </el-form-item>
                </el-col>
              ...
              <el-row :gutter="15">
                <el-col :span="24">
                  <el-form-item label="宿舍楼" prop="floorName">
                    <el-input v-model="formData4.floorName" placeholder="请输入宿舍楼" clearable
                               :style="{width: '100%'}">
                    </el-input>
                  </el-form-item>
                </el-col>
              ...
              <el-row :gutter="15">
                <el-col :span="24">
                  <el-form-item label="楼层" prop="dormFloor">
                    <el-input v-model="formData4.dormFloor" placeholder="请选择楼层" clearable
                               :style="{width: '100%'}">
                    </el-input>
                  </el-form-item>
                </el-col>
            ...
            <el-col :span="12">
              <el-row :gutter="15">
                <el-col :span="24">
                  <el-form-item label="姓名" prop="name">
                    <el-select v-model="formData4.name" placeholder="请选择姓名" clearable :style="{width: '100%'}" @change="getlivepeopleinfo4($event)">
                      <el-option v-for="(item, index) in nameOptions4" :key="index" :label="item.label"
                                 :value="item.value" :disabled="item.disabled"></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
              ...
              <el-row :gutter="15">
                <el-col :span="24">
                  <el-form-item label="手机号" prop="phone">
                    <el-input v-model="formData4.phone" placeholder="请输入手机号" :maxlength="11" show-word-limit
                              clearable prefix-icon='el-icon-mobile' :style="{width: '100%'}" disabled></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
            </el-col>
              ...
              <el-row :gutter="15">
                <el-col :span="24">
                  <el-form-item label="部门" prop="department">
                    <el-input v-model="formData4.department" placeholder="请输入部门" clearable
              ...
              <el-row :gutter="15">
                <el-col :span="24">
                  <el-form-item label="工号" prop="jobNumber">
                    <el-input v-model="formData4.jobNumber" placeholder="请输入工号" clearable
                              :style="{width: '100%'}" disabled></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
...
export default {
  name: "Roominfor",
  inject:['reload'],
  dicts: ['dorm_area', 'dorm_people_count', 'sys_user_sex', 'dorm_areaNumber', 'bed_Number', 'dorm_sex'],
  data() {
    return {
      // 遮罩层
      loading: true,
