<template>
    <div class="app-container">
      ...
      <div class="table-container">
        <el-table v-loading="loading" :data="bedList" @selection-change="handleSelectionChange"  :max-height="maxHeight">
    ...
    <!--        </template>-->
          ...
          <el-table-column label="身份证号" align="center" prop="idnumber" width="100"/>
          <el-table-column label="工号" align="center" prop="jobnumber" />
          <el-table-column label="一级部门" align="center" prop="department1" />
          <el-table-column label="二级部门" align="center" prop="department2"  width="90"/>
          <el-table-column label="三级部门" align="center" prop="department3"  width="80"/>
          <el-table-column label="岗位" align="center" prop="job"  width="120"/>
  ...
  export default {
    ...
    created() {
      console.log(this.$route.params.dormbed);
      if(this.$route.params.dormbed==undefined){
        this.getList();
      }else{
        this.getList2(this.$route.params.dormbed);
      }
